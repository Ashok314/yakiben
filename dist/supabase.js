...
// Test connection to Supabase by fetching data from a sample table
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, exports.supabase.from('users').select('*').limit(1)];
                case 1:
                ...
                case 2:
                    err_1 = _b.sent();
                    console.error('Unexpected error during Supabase connection test:', err_1);
                    return [2 /*return*/, false];
